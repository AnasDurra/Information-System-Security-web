          ...
          {current === 0 && (
            <div>
              <div style={contentStyle}>
                ...
                >
                  <Input style={{ width: '40%' }} placeholder="full name" prefix={<IoPersonOutline />} />
                </Form.Item>
              </div>
                ...
                >
                  ...
                  {(current < steps.length - 1 || current === steps.length - 1) && (
                    <Button
                      ...
                      htmlType="submit"
                    >
                      {current < steps.length - 1 ? <span>Next</span> : <span>Done</span>}
                    </Button>
                  )}
                </div>
              </Form.Item>
              ...
              <div style={contentStyle}>
                <Form.Item
                  ...
                  rules={[
                    ...
                    {
                      pattern: /^09\d{8}$/,
                      message: 'Please enter a valid phone number starting with 09xxxxxxxx',
                    },
                  ]}
                >
                  <Input style={{ width: '40%' }} placeholder="09xxxxxxxx" prefix={<MobileTwoTone />} />
                </Form.Item>
              </div>
              <Form.Item>
                <div
          ...
          {current === 2 && (
            <div>
              <div style={contentStyle}>
                ...
                >
                  <Input style={{ width: '40%' }} placeholder="سرغايا - الشارع العام - ريف دمشق - سوريا" />
                </Form.Item>
                ...
                >
                  <Input style={{ width: '40%' }} placeholder="password" />
                </Form.Item>
              </div>
              <Form.Item>
                <div
